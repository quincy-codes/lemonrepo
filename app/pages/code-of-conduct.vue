  ...
  <div class="max-w-4xl mx-auto">
    <UContainer class="max-w-8xl py-12 space-y-6">
      ...
      <div class="prose prose-lg max-w-none">
        ...
        <p>This Code of Conduct is adapted from the Contributor Covenant, version 2.0, available at <a href="https://www.contributor-covenant.org/version/2/0/code_of_conduct.html" target="_blank" class="text-blue-600 hover:underline">https://www.contributor-covenant.org/version/2/0/code_of_conduct.html</a></p>
      </div>
    </UContainer>
  </div>
</template>
