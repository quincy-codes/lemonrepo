<template>
  <div class="max-w-4xl mx-auto">
    <UContainer class="max-w-8xl py-12 space-y-6">
      ...
      <h2 class="text-2xl font-semibold text-gray-900">Creating Custom Extensions</h2>
      <p class="text-gray-700">Extend Evolve by adding new functionality through packages.</p>

      <pre class="bg-gray-800 rounded-lg p-4 overflow-x-auto text-green-400">
        <code>
namespace CustomPackage;

use ThinkNeverland\Evolve\Services\EvolveService;

class CustomFeature {
    public function register(EvolveService $evolve) {
